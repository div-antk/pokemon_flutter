...
class _RestClient implements RestClient {
  ...
  @override
  Future<PokemonSpacies> fetchPokemonSpacies(String name) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PokemonSpacies>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PokemonSpacies.fromJson(_result.data!);
    return value;
  }
